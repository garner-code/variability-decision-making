function [] = generate_channel_loc_json(head_circ)
...
root_dir = '~/Dropbox/QBI/variability-learning';
project = 'iforage-v1-rawdata';
name = 'task-iforage-v1_channel-coordsystem';
elec_json_name = fullfile(root_dir,project,...
                 [name '.json']);
