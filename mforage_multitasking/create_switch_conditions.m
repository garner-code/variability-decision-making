function [trial_struct] = create_switch_conditions(trial_struct, ntrials, p)
    ...
    tmp_trial_struct(tmp_trial_struct(:,2) == 1, 3:size(tmp_trial_struct,2)) ...
        = trial_struct(trial_struct(:,2) == 1, 3:size(trial_struct,2));
    tmp_trial_struct(tmp_trial_struct(:,2) == 2, 3:size(tmp_trial_struct,2)) ... 
        = trial_struct(trial_struct(:,2) == 2, 3:size(trial_struct,2));
